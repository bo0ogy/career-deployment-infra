...
\begin{minipage}[c]{0.78\textwidth}
    ...
    {\large \textbf{Analyste SecOps \& Auditeur Sécurité (Blue Team)}}\\[0.1cm]
...
\begin{minipage}[c]{0.18\textwidth}
    ...
    \begin{tikzpicture}
        ...
        \node at (0,0) {\includegraphics[width=1.70cm,height=1.70cm]{../master_ssot/hamza.jpeg}};
    \end{tikzpicture}
\end{minipage}
